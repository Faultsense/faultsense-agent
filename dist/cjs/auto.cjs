/*! Faultsense agent (cjs/auto) v0.5.3 | FSL-1.1-ALv2 | https://faultsense.com */
"use strict";
...
(function() {
  function extractConfigFromScriptTag() {
    ...
    let resolvedCollectorUrl = collectorUrl || void 0;
    ...
    return {
      apiKey: script.getAttribute("data-api-key") || (typeof resolvedCollectorUrl === "function" ? "dev-collector" : void 0),
      releaseLabel: script.getAttribute("data-release-label") || void 0,
      collectorURL: resolvedCollectorUrl,
      gcInterval: Number(script.getAttribute("data-gc-interval")) || void 0,
      unloadGracePeriod: Number(script.getAttribute("data-unload-grace-period")) || void 0,
